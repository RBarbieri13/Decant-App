 ...
 */
export async function classifyContent(scraped, apiKey) {
 ...
 */
function sanitizeKeyConcepts(concepts) {
 ...
 */
function validateCode(value, allowed, fallback) {
 ...
 */
export function getSegmentName(code) {
    return SEGMENTS[code] || 'Unknown';
}
/**
 * Get content type name from code
 */
export function getContentTypeName(code) {
    return CONTENT_TYPES[code] || 'Unknown';
}
